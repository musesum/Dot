...
static void TCPServerAcceptCallBack(CFSocketRef socket, CFSocketCallBackType type, CFDataRef address, const void *data, void *info) {
    ...
    TCPServer *server = (__bridge TCPServer*)info; //ARC
    if (kCFSocketAcceptCallBack == type) { 
        ...
        if (readStream && writeStream) {
            ...
            [server handleNewConnectionFromAddress:peer inputStream:(__bridge NSInputStream*)readStream outputStream:(__bridge NSOutputStream*)writeStream]; //ARC
        } else {
...
- (BOOL)start:(NSError **)error {
    ...
    CFSocketContext socketCtxt = {0, (__bridge void*)(self), NULL, NULL, NULL};
     _ipv4socket = CFSocketCreate(kCFAllocatorDefault, AF_INET, SOCK_STREAM, 0, kCFSocketAcceptCallBack,  (CFSocketCallBack)&TCPServerAcceptCallBack, &socketCtxt);
