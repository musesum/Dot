...
@interface NSNetService (BrowserVCAdditions)
- (NSComparisonResult) localizedCaseInsensitiveCompareByName:(NSNetService*)aService;
@end

@implementation NSNetService (BrowserVCAdditions)
- (NSComparisonResult) localizedCaseInsensitiveCompareByName:(NSNetService*)aService {
...
- (BOOL)searchForServicesOfType:(NSString*)type inDomain:(NSString*)domain {
	...
	aNetServiceBrowser.delegate = (id)self;
...
- (void)tableView:(UITableView*)tableView didSelectRowAtIndexPath:(NSIndexPath*)indexPath {
	...
	[self.currentResolve setDelegate:(id)self];
...
- (void)netServiceDidResolveAddress:(NSNetService*)service {
	...
	[self.delegate browserVC:self didResolveInstance:service];
}

- (void)cancelAction {
	[self.delegate browserVC:self didResolveInstance:nil];
}
